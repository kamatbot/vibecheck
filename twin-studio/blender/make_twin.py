...
def sdf_head(P):
    ...
    for s in (-1,1):
        ...
        d=smin(d,ell(P,(s*.050,-.040,1.472),(.034,.034,.034)),.030)  # buccal fullness
        d=smin(d,chain(P,[(s*.084,.030,1.518),(s*.064,.014,1.450),(s*.026,-.070,1.410)],[.015,.013,.013],.02),.032)  # jaw
        d=smin(d,ell(P,(s*.060,-.006,1.480),(.030,.042,.046)),.032)  # masseter
