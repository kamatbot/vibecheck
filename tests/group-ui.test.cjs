...
function harness(){
 ...
 const ctx=vm.createContext({VibeChain,PreferenceQuiz:require("../preference-quiz.js"),$,document:{querySelector:$,createElement:node},location:{hash:'',origin:'https://example.test',pathname:'/'},history:{replaceState(){}},setTimeout(){},requestAnimationFrame(){},performance:{now:()=>0},show(){},renderQ(){},buildVibe(p){ctx.built=p}});
